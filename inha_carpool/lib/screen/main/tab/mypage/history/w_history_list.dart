      ...
      body: Container(
        ...
        child: ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            ...
            String member1 = historyState[index].member1;
            String member2 = historyState[index].member2;
            String member3 = historyState[index].member3;
            String member4 = historyState[index].member4;
            ...
            List<String> validMembers = members.where((member) {
              return member != '' && member.split('_')[1] != authState.nickName;
            }).toList();
                ...
                return Column(
                  children: [
                    ...
                    for (var member in validMembers)
                      buildMemberRow(member, historyState[index].carPoolId,
                          authState.nickName!),
                  ],
                );
              }
