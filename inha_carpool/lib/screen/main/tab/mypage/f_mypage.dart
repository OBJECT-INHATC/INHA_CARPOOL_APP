...
class _ProFileState extends State<ProFile> {
  TextEditingController _nameController = TextEditingController(text: "홀란드");
    ...
    if (newName != null) {
      ...
      showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            title: Text("수정 완료"),
            content: Text("이름이 성공적으로 수정되었습니다."),
            actions: [
              TextButton(
                onPressed: () {
                  Navigator.of(context).pop();
        ...
        actions: [
          ...
          IconButton(
            ...
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => SettingsScreen()), // SettingPage로 이동
              );
            },
          ),
        ],
