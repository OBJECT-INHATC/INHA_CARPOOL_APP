...
class LocationInputCopy extends ConsumerStatefulWidget {
  final LatLng point;

  const LocationInputCopy(this.point, {super.key});

  @override
  ConsumerState<LocationInputCopy> createState() => _LocationInputState();
}

class _LocationInputState extends ConsumerState<LocationInputCopy> {
  int flex = 50;
