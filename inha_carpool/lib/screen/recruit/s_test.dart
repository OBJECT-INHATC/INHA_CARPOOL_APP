...
import 'package:inha_Carpool/screen/recruit/map/w_appbar.dart';
...
class test extends ConsumerStatefulWidget {
  ...
  const test(this.point, {super.key});

  @override
  ConsumerState<test> createState() => _LocationInputState();
}

class _LocationInputState extends ConsumerState<test> {
  int flex = 50;
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          const Line(),
          Container(
            height: _addressList.isNotEmpty ? height * 0.4 : height * 0.15,
