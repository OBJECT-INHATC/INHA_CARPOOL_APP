class DetailContent {
  ...
  '''
제1조 (목적)
인하카풀은 택시 공유 서비스를 제공하는 플랫폼으로, 사용자들을 매칭하여 출발지와 목적지 간의 거리를 계산하고 채팅 기능을 통해 사용자들끼리 소통할 수 있도록 합니다. 이를 통해 사용자들은 택시를 이용하면서 택시비를 절약할 수 있습니다.

제2조 (정의)
1. "인하카풀"은 택시 공유 서비스를 이용자에게 제공하기 위해 개발된 모바일 플랫폼을 말합니다.
1. "이용자"란 "인하카풀" 서비스를 이용하는 모든 회원 및 비회원을 지칭합니다.

제3조 (서비스 제공 및 변경)
1. "인하카풀"은 택시를 나누는데 필요한 정보를 제공하며, 서비스의 내용이 변경되는 경우 이를 사용자에게 통지합니다.

제4조 (위치정보 및 거리 계산)
1. "인하카풀"은 사용자의 위치정보를 활용하여 출발지와 목적지 간의 거리 및 사용자와 출발지 까지의 거리를 계산하고 표시합니다.
...
3. 회원은 회원의 ID 및 비밀번호가 도용되거나 제3자가 사용하고 있음을 인지한 경우, 이를 즉시 회사에 통지하고 회사의 안내에 따라야 하며, 해당 사실을 회사에게 통지하지 않았거나 통지한 경우에도 회사의 안내를 따르지 않아 발생한 불이익에 대하여는 회사가 책임지지 않습니다.
4. 회원의 ID와 비밀번호에 관한 관리 책임은 회원에게 있으며, 회원의 관리 소홀에 따라 제3자가 이용하게 되어 피해가 발생했을 경우에는 회사가 책임지지 않습니다.
5. 회원은 관련 법령, 본 약관의 규정, 서비스 이용과 관련하여 공지한 이용 안내 및 주의사항, 회사가 통지하는 각종 사항 등을 준수하여야 하며, 회사가 관련법 및 개인정보 취급방침에 따라 책임을 지는 경우를 제외하고 관리 소홀 및 부정 사용 등에 의하여 발생하는 모든 결과에 대한 책임은 회원에게 있습니다.
...
9. 회원은 관계 법령 및 약관의 규정을 비롯하여 회사가 통지하는 사항을 준수하여야 하며, 회사의 서비스 운영을 고의로 방해하거나 서비스의 안정적인 운영을 방해할 수 있는 정보 및 수신자의 명시적인 수신거부 의사에 반하여 광고 목적의 정보를 전송하는 행위를 해서는 안됩니다.
...
2. 회사는 본 약관의 적용과 함께 유료 서비스 및 개별 서비스에 대한 별도의 이용약관과 정책을 제시하여 적용할 수 있습니다.
3. 본 약관에서 정하지 아니한 사항과 본 약관의 해석에 관하여는 관련법 또는 상관례에 따릅니다.

제 8조 (회원의 금지행위)
1. 회원은 서비스를 이용할 때 다음 각 호의 행위를 하여서는 아니 됩니다.
① 이용 신청 또는 변경 시 허위 사실을 기재하거나, 다른 회원의 계정을 도용, 부정하게 사용하거나, 이동 전화 명의자의 허락 없이 실사용자가 “SMS 인증”, 범용공인인증 또는 신용카드인증 등을 수행하는 행위
...
⑧ 서비스 운영을 고의로 방해하거나 서비스의 안정적 운영을 방해할 수 있는 정보 및 수신자의 명시적인 수신거부의사에 반하여 광고성 정보 또는 스팸메일(Spam Mail)을 전송하는 행위
⑨ 다른 회원의 개인정보를 수집, 저장, 공개하는 행위
⑩ 스토킹(stalking), 외설 또는 폭력적인 언행, 기타 미풍양속을 해치는 행위 등으로 다른 회원을 괴롭히는 행위
⑪ 탑승의사 없이 호출하거나 호출에 응하는 행위
⑫ 택시 호출 시 실제 목적지와 상이한 목적지를 선택하거나, 택시를 호출하여 배차가 완료된 이후 경로변경을 요구하여 동승한 다른 회원에게 불편을 초래하는 행위
...
1. 회원은 관계 법령, 본 약관의 규정, 서비스정책, 이용안내 및 서비스상에 공지한 주의사항, 회사가 통지하는 사항 등을 준수하여야 하며, 기타 회사의 업무에 방해되는 행위를 하여서는 아니 됩니다.
2. 회원이 명시된 금행위를 한 경우에 회사는 부가적으로 제공한 혜택의 일부 또는 전부의 회수, 특정 서비스의 이용제한, 이용계약의 해지, 손해배상의 청구 등의 조치를 할 수 있습니다
  ''';
...
개인정보처리방침
제1조(목적)
1. 오브젝트(이하 ‘회사'라고 함)는 회사가 제공하고자 하는 서비스(이하 ‘회사 서비스’)를 이용하는 개인(이하 ‘이용자’ 또는 ‘개인’)의 정보(이하 ‘개인정보’)를 보호하기 위해, 개인정보보호법, 정보통신망 이용촉진 및 정보보호 등에 관한 법률(이하 '정보통신망법') 등 관련 법령을 준수하고, 서비스 이용자의 개인정보 보호 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보처리방침(이하 ‘본 방침’)을 수립합니다.

제2조(개인정보 처리의 원칙)
2. 개인정보 관련 법령 및 본 방침에 따라 회사는 이용자의 개인정보를 수집할 수 있으며 수집된 개인정보는 개인의 동의가 있는 경우에 한해 제3자에게 제공될 수 있습니다. 단, 법령의 규정 등에 의해 적법하게 강제되는 경우 회사는 수집한 이용자의 개인정보를 사전에 개인의 동의 없이 제3자에게 제공할 수도 있습니다.
...
제11조(개인정보의 파기원칙)
1. 회사는 원칙적으로 이용자의 개인정보 처리 목적의 달성, 보유·이용기간의 경과 등 개인정보가 필요하지 않을 경우에는 해당 정보를 지체 없이 파기합니다.

제12조(개인정보 조회 및 수집동의 철회)
1. 이용자는 언제든지 등록되어 있는 자신의 개인정보를 조회하거나 수정할 수 있으며 개인정보수집 동의 철회를 요청할 수 있습니다.
2. 이용자는 자신의 가입정보 수집 등에 대한 동의를 철회하기 위해서는 개인정보보호책임자 또는 담당자에게 서면, 전화 또는 전자우편주소로 연락하시면 회사는 지체 없이 조치하겠습니다.
...
위치기반서비스 이용약관
제1조(목적)
본 약관은 회원(오브젝트의 서비스 약관에 동의한 자를 말하며 이하 '회원'이라고 합니다)이 오브젝트(이하 '회사'라고 합니다)가 제공하는 웹페이지 및 '인하카풀' (회사가 개발 운영하는 모바일 애플리케이션을 말합니다 이하 '모바일앱'이라고 합니다)의 서비스를 이용함에 있어 회원과 회사의 권리 및 의무, 기타 제반 사항을 정하는 것을 목적으로 합니다.
